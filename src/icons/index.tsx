    ...
    >
      <g transform="translate(0 1)">
        <g>
          <path
            style={{ fill: "#B3CD4B" }}
            d="M386.068,128.967H125.729C129.2,91.652,165.648,24.831,256.766,24.831
			C343.546,24.831,382.597,91.652,386.068,128.967"
          />
          <path
            style={{ fill: "#B3CD4B" }}
            d="M56.305,354.594L56.305,354.594c-19.092,0-34.712-15.62-34.712-34.712V198.391
			c0-19.092,15.62-34.712,34.712-34.712s34.712,15.62,34.712,34.712v121.492C91.017,338.974,75.397,354.594,56.305,354.594"
          />
          <path
            style={{ fill: "#B3CD4B" }}
            d="M455.492,354.594L455.492,354.594c-19.092,0-34.712-15.62-34.712-34.712V198.391
			c0-19.092,15.62-34.712,34.712-34.712c19.092,0,34.712,15.62,34.712,34.712v121.492
			C490.204,338.974,474.583,354.594,455.492,354.594"
          />
          <path
            style={{ fill: "#B3CD4B" }}
            d="M351.356,397.984v86.78c0,14.753-11.281,26.034-26.034,26.034
			c-14.753,0-26.034-11.281-26.034-26.034v-86.78h-86.78v86.78c0,14.753-12.149,26.034-26.034,26.034s-26.034-11.281-26.034-26.034
			v-86.78h-34.712V163.679h260.339v234.305H351.356z"
          />
        </g>
        <g>
          <path
            style={{ fill: "#FFFFFF" }}
            d="M229.865,85.577c0-9.546-7.81-17.356-17.356-17.356c-9.546,0-17.356,7.81-17.356,17.356
			s7.81,17.356,17.356,17.356C222.055,102.933,229.865,95.123,229.865,85.577"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M316.644,85.577c0-9.546-7.81-17.356-17.356-17.356s-17.356,7.81-17.356,17.356
			s7.81,17.356,17.356,17.356C308.834,102.933,316.644,95.123,316.644,85.577"
          />
        </g>
        <g>
          <path
            style={{ fill: "#B3CD4B" }}
            d="M185.607,50.865c-3.471,0-6.075-1.736-7.81-5.207l-16.488-34.712
			c-1.736-4.339,0-9.546,4.339-11.281c4.339-1.736,9.546,0,11.281,4.339l16.488,34.712c1.736,4.339,0,9.546-4.339,11.281
			C188.211,49.997,187.343,50.865,185.607,50.865z"
          />
          <path
            style={{ fill: "#B3CD4B" }}
            d="M325.322,50.865c-0.868,0-2.603,0-3.471-0.868c-4.339-1.736-6.075-6.942-4.339-11.281L334,4.004
			c1.736-4.339,6.942-6.075,11.281-4.339c4.339,1.736,6.075,6.942,4.339,11.281l-16.488,34.712
			C332.265,49.129,328.794,50.865,325.322,50.865z"
          />
        </g>
      </g>
    </svg>
...
export function LikeIcon(props: ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      width="24"
...
export function DislikeIcon(props: ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function IonicIcon(props: ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      width="800px"
...
export function VueIcon(props: ComponentProps<"svg">) {
  return (
    ...
    >
      <g>
        <path
          d="M15.7489 9.52234L24.3747 9.52571L30.0132 18.885L35.6318 9.52646L44.25 9.52421L30.0563 34.1448L15.7489 9.52234Z"
          fill="#35495E"
        />
        <path
          d="M6.34131 9.58843L15.7414 9.52393L30.0477 34.146L44.2426 9.52543L53.6588 9.53518L30.0466 50.0577L6.34131 9.58843Z"
          fill="#41B883"
        />
      </g>
    </svg>
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.24652C6.47672 2.24652 2 6.72324 2 12.2465C2 16.663 4.86576 20.4109 8.83836 21.7369C9.33699 21.8301 9.52329 21.5178 9.52329 21.2548C9.52329 21.0137 9.51234 20.2301 9.51234 19.3917C6.72877 19.9945 6.14247 18.2137 6.14247 18.2137C5.68767 17.0575 5.03014 16.7506 5.03014 16.7506C4.12055 16.1315 5.09589 16.1424 5.09589 16.1424C6.09863 16.2137 6.63014 17.1726 6.63014 17.1726C7.52329 18.7013 8.96987 18.2575 9.53973 18.0054C9.6274 17.3589 9.89042 16.9205 10.1754 16.6685C7.95617 16.4164 5.61644 15.5561 5.61644 11.726C5.61644 10.6356 6.00548 9.74242 6.64658 9.04105C6.54247 8.78899 6.20274 7.76981 6.74521 6.39447C6.74521 6.39447 7.58357 6.12598 9.4959 7.41913C10.2959 7.19995 11.1507 7.08488 12 7.08488C12.8493 7.09036 13.7041 7.19995 14.5041 7.41913C16.411 6.12598 17.2493 6.39447 17.2493 6.39447C17.7918 7.76981 17.4521 8.78899 17.348 9.04105C17.9891 9.74242 18.3781 10.6356 18.3781 11.726C18.3781 15.5671 16.0384 16.4109 13.8137 16.6575C14.1699 16.9698 14.4932 17.578 14.4932 18.5095C14.4932 19.8465 14.4822 20.926 14.4822 21.2548C14.4822 21.5233 14.663 21.8301 15.1671 21.7369C19.1397 20.4109 22 16.6685 22 12.2465C22 6.72324 17.5233 2.24652 12 2.24652Z"
        fill="currentColor"
      />
      <path
        d="M5.78629 16.6027C5.76437 16.652 5.68766 16.6684 5.61643 16.6355C5.54519 16.6027 5.50136 16.5369 5.52875 16.4876C5.55067 16.4383 5.62738 16.4218 5.69862 16.4547C5.76985 16.4876 5.81369 16.5534 5.78629 16.6027Z"
        fill="currentColor"
      />
      <path
        d="M6.19181 17.0575C6.1425 17.1013 6.04935 17.0794 5.98908 17.0137C5.92332 16.9424 5.91236 16.8493 5.96168 16.8055C6.01099 16.7616 6.09866 16.7835 6.16442 16.8493C6.23017 16.9205 6.24113 17.0137 6.19181 17.0575Z"
        fill="currentColor"
      />
      <path
        d="M6.58639 17.6329C6.52612 17.6767 6.42749 17.6384 6.36173 17.5452C6.30146 17.4575 6.30146 17.3479 6.36173 17.3041C6.42201 17.2603 6.52064 17.2986 6.58639 17.3863C6.65214 17.4794 6.65214 17.589 6.58639 17.6329Z"
        fill="currentColor"
      />
      <path
        d="M7.1287 18.1862C7.07391 18.2465 6.95884 18.2301 6.87117 18.1479C6.7835 18.0657 6.76158 17.9506 6.81637 17.8903C6.87117 17.8301 6.99172 17.8465 7.07391 17.9287C7.16158 18.0164 7.1835 18.1314 7.1287 18.1862Z"
        fill="currentColor"
      />
      <path
        d="M7.874 18.5096C7.85209 18.5863 7.73702 18.6247 7.62195 18.5918C7.50688 18.5589 7.43565 18.4658 7.45757 18.3891C7.47948 18.3123 7.59455 18.274 7.70962 18.3069C7.81921 18.3397 7.89592 18.4329 7.874 18.5096Z"
        fill="currentColor"
      />
      <path
        d="M8.69032 18.5698C8.6958 18.652 8.59717 18.7232 8.47662 18.7232C8.35608 18.7287 8.26293 18.6575 8.25745 18.5753C8.25745 18.4931 8.3506 18.4219 8.47115 18.4219C8.59169 18.4219 8.69032 18.4876 8.69032 18.5698Z"
        fill="currentColor"
      />
      <path
        d="M9.45198 18.4438C9.46842 18.526 9.38623 18.6082 9.26568 18.6301C9.15061 18.652 9.04102 18.6027 9.03006 18.5205C9.01362 18.4383 9.10129 18.3561 9.21636 18.3342C9.33143 18.3123 9.43554 18.3616 9.45198 18.4438Z"
        fill="currentColor"
      />
    </svg>
  );
