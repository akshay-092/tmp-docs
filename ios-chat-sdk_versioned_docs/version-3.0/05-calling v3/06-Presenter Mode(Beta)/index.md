...
| setAudioModeButtonDisable(Bool) | If set to true it displays the AudioModeButton in Button Layout.  if set to false it hides the AudioModeButton in Button Layout <br />**Default value = true** | 
