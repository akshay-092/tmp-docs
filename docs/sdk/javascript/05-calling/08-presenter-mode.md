...
| `setIsAudioOnlyCall(audioOnly: boolean)` | If set to `true`, the call will be strictly an audio call. <br/>If set to `false`, the call will be an audio-video call.**Default value = false** | 
