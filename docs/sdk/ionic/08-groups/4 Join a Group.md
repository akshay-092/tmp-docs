...
| `groupType` | Type of the group. CometChat provides 3 types of groups viz. <br/>a. CometChatConstants.GROUP_TYPE_PUBLIC (public) <br/>b. CometChatConstants.GROUP_TYPE___PASSWORD (password) <br/>c. CometChatConstants.GROUP_TYPE_PRIVATE (private) | 
