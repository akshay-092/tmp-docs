...
| `showAudioModeButton(boolean value)`                   | If set to `true`, it displays the Audio Mode Button in the Button Layout. If set to `false`, it hides the Audio Mode Button in the Button Layout. <br/>Default value = `true`                  |
