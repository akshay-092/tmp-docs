...
| `bool showSwitchToVideoCallButton` | This method shows\/hides the switch to video call button. If set to true it will display the switch to video call button. If set to false it will hide the switch to video call button.<br/>Default value = `true` |
...
| `bool startRecordingOnCallStart` | If set to `true` it start recording automatically once call is connected<br/>Default value = `false` |
...
| `MainVideoContainerSetting setMainVideoContainerSetting` | This method can be used to customize the main video container. You can read more about this [here](./video-view-customisation) |
