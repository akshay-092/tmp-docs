...
import MessageStructureAndHierarchyImg from "./assets/1633625271.png"
...
<div class="image_wrapper" style={{display: "flex",justifyContent: "center"}}>
  <img src={MessageStructureAndHierarchyImg} width="385px" alt="Message Structure and Hierarchy" />
</div>
