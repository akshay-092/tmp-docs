...
<Tabs>
<TabItem value="js1" label="Text Message">
...
<TabItem value="ts1" label="Custom Message">
...
<TabItem value="js" label="Text Message (Typescript)">
...
<TabItem value="ts" label="Custom Message (Typescript)">
