...
| 6. | Shuffle or re-arrange tabs | `UIKitSettings.tabs = [.chats, .calls, .users , .groups, .settings]` | You can re-arrange, remove or add tabs using this. This method takes the array of `Controller` which has following parameters. <br />1. **Chats:** Show recent chats<br />2. **Calls:** Show calls<br />3. **Users:** Show users<br />4. **Groups:** Show groups<br />5. **Settings:** Show user information tab | 
