...
![](../../assets/Reactions_list_overview_overview_cometchat.png)
...
In this example, we are using the `OnClick` action. -->
...
<!-- The `Reactions List` component does not provide any exposed filtering options. -->
