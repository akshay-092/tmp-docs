...
<!-- ![](./assets/86ibsl3zs5qhhd1yxc7nqshotw37vnp4h8o415y2x7i84ua88dq6jny0xhkr6jd4.png) -->
...
To apply customized styles to the `Avatar` component in the `Conversations` Component, you can use the following code snippet. For further insights on `Avatar` Styles [refer](/ui-kit/ios/avatar#methods)
...
<!-- ![](./assets/b93058cced7c0dce4f852da1822b870df17975e9.png) -->
...
<!-- This method handles the assignment of text formatters. If a custom list is provided and not empty, it sets the list accordingly. Otherwise, it falls back to using the default text formatters retrieved from the data source for enhanced functionality. -->
...
<!-- ![](./assets/644d58c0b042e53cc4a1c681eba90305178f57ad.png) -->
...
<!-- ![](./assets/cfde3f84ea162f995c608d7d607884512b4fed26.png) -->
